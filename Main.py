...
topics =   {1   : 'Arrays', 2 : 'Vectors', 3 : 'Queues', 4 : 'Javascript', 
            5 : 'HTML',     6 : 'PHP',     7 :'Dynamic', 8 : 'Greedy', 9 :'DFS'}
...
#Second test to see if it picks out the greates proficiency no matter what         
